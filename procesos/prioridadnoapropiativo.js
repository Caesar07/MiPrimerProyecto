...
var prioridadnoapropiativo = function(numero){
 ...
 this.utilizarhilo=function(){
    ...
    if (listacritica.getcantidadelementos()===0){
        if (listalisto.getcantidadelementos()!==0){//ingreso proceso a critico
            var posiciontiempomascorto = this.getprocesoconprioridadmascorto(listalisto);
            ...
            if (algoritmo.revisarrecursosdisponibless(listalisto.getelementoposicion(posiciontiempomascorto))) {//revision disponibilidad de recursos
        ...
        if (elementoprocesando.gettiempouso()-1===0){//proceso a terminado
            ...
            if (!this.reisarsisacardecritico(listalisto,
            listacritica.getelementoprimerocola().gettiempouso(),
            listacritica.getelementoprimerocola().getprioridad())){
                //cambio logico
            ...
            document.getElementById("tiempoprocesos"+(numerocpu)).innerHTML =( "procesando cpu #"+numerocpu+
                ...
                elementoprocesando.setquantum(algoritmo.tiemposuspendido(procesoasuspendido.gettiempouso()));
                this.agregarobjeto(procesoasuspendido,2);
                //cambio fisico
                algoritmo.ingresarprocesoentabla(2,procesoasuspendido,false);
