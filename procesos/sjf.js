 ...
 this.utilizarhilo=function(){
    ...
    if (listacritica.getcantidadelementos()===0){
        if (listalisto.getcantidadelementos()!==0){//ingreso proceso a critico
            ...
            if (algoritmo.revisarrecursosdisponibless(listalisto.getelementoposicion(posiciontiempomascorto))
                    || listalisto.getelementoposicion(posiciontiempomascorto).getapropiacion()) {//revision disponibilidad de recursos
